#!/bin/bash
#Env file
  export DT_TENANT_URL="https://xxx.live.dynatrace.com"      #Saas=> https://xxx.live.dynatrace.co, Managed=> https://domain.managed.com/e/tenantid
  export DT_API_TOKEN="XXX"                                  #scope : Read_configuration, Write_configuration, Read_SLO & Write_SLO
