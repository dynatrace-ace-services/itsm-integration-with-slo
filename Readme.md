...
- SLO Simply Smarter with included SLO configuration (for tenant, filtered by MZ) : click [here](https://github.com/dynatrace-ace-services/slo-simply-smarter#readme)  
